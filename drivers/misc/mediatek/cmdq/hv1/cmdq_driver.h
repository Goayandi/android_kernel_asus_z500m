...
/*
**	Get fence fd from CMDQ
*/
#define CMDQ_IOCTL_GET_FENCE_FD _IOR(CMDQ_IOCTL_MAGIC_NUMBER, 12, struct cmdqFenceStruct)
#define CMDQ_IOCTL_RELEASE_FENCE_FD _IOW(CMDQ_IOCTL_MAGIC_NUMBER, 13, struct cmdqFenceStruct)
...
enum IOCTL_RETURN_CODE {
	...
	IOCTL_RET_COPY_FENCE_TO_USER_FAIL						=	38,
	IOCTL_RET_GET_FENCE__FAIL								=	39,
	IOCTL_RET_RELEASE_FENCE_FAIL							=	40,
	IOCTL_RET_COPY_FENCE_FROM_USER_FAIL						=	41,
	IOCTL_RET_UNRECOGNIZED_IOCTL							=	42,

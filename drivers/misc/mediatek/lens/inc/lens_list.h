...
#ifdef CONFIG_MTK_LENS_S2034AF_SUPPORT
extern void S2034AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long S2034AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param);
extern int S2034AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif
#endif
